...
<p align="center">
  <img src=".github/assets/sotto-app-icon-v2.png" width="144" alt="Sotto app icon">
</p>
...
保存先、使用するマイク、ビットレート、ログイン時の起動、マイクとシステム音声のゲインなどは設定画面から変更できます。`入力チェックを開始`を押すと、録音せずに入力レベルを確認できます。

### Bluetoothイヤホンの音質

AirPodsなどのBluetoothイヤホンは、内蔵マイクの使用中に通話用モードへ切り替わり、再生音質が下がります。設定の`使用するマイク`でMac内蔵マイクや有線マイクを選ぶと回避できます。

TeamsやGoogle Meetも同時に使う場合は、そちらの入力マイクもBluetoothイヤホン以外に設定してください。有線イヤホンではこの切り替えは発生しません。
